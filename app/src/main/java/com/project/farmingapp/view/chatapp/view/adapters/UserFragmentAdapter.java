package com.project.farmingapp.view.chatapp.view.adapters;
...
import com.project.farmingapp.view.chatapp.view.ui.MessageActivity;
    ...
    public void onBindViewHolder(@NonNull UserFragmentHolder holder, int position) {
        ...
        holder.iv_profile_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bottomSheetProfileDetailUser = new BottomSheetProfileDetailUser(userName, imageUrl, bio, context,userId);
